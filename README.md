...
品牌名称已改为“烤鸭箱”。为兼容已有用户的自动更新，暂时保留文件名和仓库地址。
...
- 当前版本：v1.1.5
- 文件大小：25,220,608 字节
- SHA-256：FD53AB8112083175BF1AD22EEB5CFD975616C190821076B4E1886C214BC15D9A
...
- **Alt+Q**：打开操作面板与剪贴板历史，可查看文字、图片和文件记录（各独立最多保存 150 条）；双击记录可重新复制，也可右键置顶、删除或清空。支持透明度与贴边吸附设置、Windows 任务栏最小化及贴边收起。
